      ...
      <div class="form-area">
        ...
        if(mysqli_num_rows($result1)){
            while($row1 = mysqli_fetch_assoc($result1)){
                ...
                $self_price = $row1["self_price"];
                $non_self_price = $row1["non_self_price"];
                $self_price_per_day = $row1["self_price_per_day"];
                $non_self_price_per_day = $row1["non_self_price_per_day"];
            }
        }
        ...
        <div ng-switch-default>
                ...
                <!-- </div>    -->
                    ...
                    <!-- <div class="form-group"> -->
                <h5>Fare: <b><?php echo("Rs. " . $self_price . "/km and Rs. " . $self_price_per_day . "/day");?></b><h5>    
                <!-- </div>    -->
                     </div>
                     <div ng-switch-when="non_ac">
                     <!-- <div class="form-group"> -->
                <h5>Fare: <b><?php echo("Rs. " . $non_self_price . "/km and Rs. " . $non_self_price_per_day . "/day");?></b><h5>    
                <!-- </div>   -->
                     </div>
        </div>
